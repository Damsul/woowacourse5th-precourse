...
class WinningNumbersTest {
    ...
    void firstPrize() {
        ...
        assertThat(winningNumbers.calculateRanking(myLotto)).isEqualTo(Ranking.FIRST);
    }
    ...
    void secondPrize() {
        ...
        assertThat(winningNumbers.calculateRanking(myLotto)).isEqualTo(Ranking.SECOND);
    }
    ...
    void thirdPrize() {
        ...
        assertThat(winningNumbers.calculateRanking(myLotto)).isEqualTo(Ranking.THIRD);
    }
    ...
    void fourthPrize() {
        ...
        assertThat(winningNumbers.calculateRanking(myLotto)).isEqualTo(Ranking.FOURTH);
    }
    ...
    void fifthPrize() {
        ...
        assertThat(winningNumbers.calculateRanking(myLotto)).isEqualTo(Ranking.FIFTH);
    }
}